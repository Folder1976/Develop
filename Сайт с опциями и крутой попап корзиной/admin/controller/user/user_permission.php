...
class ControllerUserUserPermission extends Controller {
	...
	protected function getForm() {
		...
		while (count($path) != 0) {
			...
			// << Related Options
			if (VERSION >= '2.3.0.0') {
				$moduleFileNameOld = DIR_APPLICATION.'controller/extension/module/related_options.php';
				$moduleFileNameNew = DIR_APPLICATION.'controller/extension/extension/module/related_options.php';
				/*
