...
// << Related Options / Связанные опции 
			...
			private function ro_get_model() {
				...
				if ( !$this->relatedoptions_model ) {
					...
					if ( !$current_registry->get('model_extension_module_related_options') ) {
						$current_loader->model('extension/module/related_options');
					}
					$this->relatedoptions_model = $current_registry->get('model_extension_module_related_options');
				}
