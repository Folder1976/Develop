...
class ControllerCommonFooter extends Controller {
	...
	public function index() {
		...
		$this->load->model('catalog/information');
	        ...
	        if (isset($oct_policy_data['value']) && $oct_policy_data['value'] && !empty($oct_policy_data['value']) && ($oct_policy_status && (!isset($this->request->cookie[$oct_policy_data['value']]) || !$this->request->cookie[$oct_policy_data['value']]))) {
