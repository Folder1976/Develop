...
// << Related Options / Связанные опции 
			...
			$data['ro_theme_name']							= $this->model_extension_module_related_options->getThemeName();
			$data['ro_data'] 										= $this->model_extension_module_related_options->get_ro_data($ro_product_id, true);
			
			$data['ros_to_select'] 							= $this->model_extension_module_related_options->getROCombSelectedByDefault($ro_product_id, isset($this->request->get['search']) ? $this->request->get['search'] : '');
        ...
        $data['ro_scripts'] = $this->model_extension_module_related_options->getProductPageScripts();
      }
...
// << Related Options
			...
			foreach ($results as $result) {
				...
				'ro_data' 			=> $this->model_extension_module_related_options ? $this->model_extension_module_related_options->getRODataForProductList($result['product_id']) : '', 
				'ro_theme_name' => $this->model_extension_module_related_options ? $this->model_extension_module_related_options->getThemeName() : '',
				'ros_to_select' => $this->model_extension_module_related_options ? $this->model_extension_module_related_options->getROCombSelectedByDefault($result['product_id']) : '',
				// >> Related Options
					'thumb'       => $image,
					'name'        => $result['name'],
