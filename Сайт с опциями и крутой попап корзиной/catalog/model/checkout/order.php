	...
	public function addOrder($data) {
		...
		if (isset($data['products'])) {
			foreach ($data['products'] as $product) {
				...
				$this->model_extension_module_related_options->updateOrderProductAdditionalFields($product, $order_product_id);
...
// << Related Options / Связанные опции 
				...
				$this->model_extension_module_related_options->update_ro_quantity((int)$order_product['product_id'], (int)$order_id, (int)$order_product['order_product_id'], (int)$order_product['quantity'], '-');
			...
			$this->model_extension_module_related_options->update_ro_quantity((int)$product['product_id'], (int)$order_id, (int)$product['order_product_id'], (int)$product['quantity'], '+');
