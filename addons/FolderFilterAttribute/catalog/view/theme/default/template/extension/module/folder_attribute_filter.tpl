  ...
  <div class="filter__list">
    ...
    <?php if(isset($prices) AND count($prices) > 1){ ?>
      ...
      <div class="filter-group__content filter-group__content--price">
        <div id="filter-group-price" class="js-range-price range-price" data-min="<?php echo $prices['min_price']; ?>" data-max="<?php echo $prices['max_price']; ?>" data-value-min="<?php echo $fprices['min_price']; ?>" data-value-max="<?php echo $fprices['max_price']; ?>" data-step="1">
