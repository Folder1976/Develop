<?php
class ControllerCatalogTranslate extends Controller {
	private $error = array();

	public function index() {
        
        $sql = "CREATE TABLE IF EXISTS `" . DB_PREFIX . "translate` (
        ...
        $sql = "CREATE TABLE IF EXISTS `" . DB_PREFIX . "translate_description` (
                  `translate_id` int(11) NOT NULL AUTO_INCREMENT,
